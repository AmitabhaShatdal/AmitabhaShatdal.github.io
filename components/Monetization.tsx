 ...
 * Horizontal variant shows custom Vanguard advertisement.
 */
export const AdBanner: React.FC<AdBannerProps> = ({ variant = 'horizontal', className = '' }) => {
  let containerClasses = "";
  let boxClasses = "border border-slate-200";
  let boxStyle: React.CSSProperties = { backgroundColor: '#FCFDFF' };

  if (variant === 'vertical') {
    containerClasses = "w-[160px]"; 
    boxClasses += " w-[160px] h-full";
    boxStyle = {
    ...
    boxClasses += " w-full h-full rounded-lg";
    return (
      <div className={`${containerClasses} ${className}`}>
        <div className={boxClasses} style={boxStyle} />
      </div>
  ...
  const handleContainerClick = () => {
    window.open('https://investor.vanguard.com', '_blank', 'noopener,noreferrer');
  };

  const handleQuoteClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    window.open('https://investor.vanguard.com/accounts-plans/vanguard-cash-plus-account', '_blank', 'noopener,noreferrer');
  };

  // Horizontal variant - Custom Vanguard Advertisement
  return (
    <div className={`w-full max-w-4xl mx-auto ${className}`}>
      <div 
        onClick={handleContainerClick}
        style={{
          border: '3px solid #96151D',
          boxSizing: 'border-box',
          background: '#fff',
          cursor: 'pointer',
          position: 'relative',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(150, 21, 29, 0.04)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'transparent';
              }}
            >
              "Americans have an estimated <span style={{ fontWeight: 700, color: '#96151D', fontStyle: 'normal' }}>$1.7 TRILLION</span> sitting in savings accounts that could be earning way more interest ... <span style={{ fontWeight: 600, fontStyle: 'normal' }}>Make sense not cents</span> with the Vanguard Cash Plus Account"
            </div>
            ...
            <div style={{
              width: '80px',
              height: '2px',
              background: 'linear-gradient(90deg, transparent, #96151D, transparent)',
              margin: '20px auto',
            }} />
            ...
            <div style={{
              ...
              Don't let your money rest. Use Vanguard to Invest
            </div>
            ...
            <div style={{
              ...
              Vanguard pioneered low-cost index investing and remains investor-owned—meaning the company works for you, not shareholders. With industry-leading expense ratios, no commission on stocks and ETFs, and over $8 trillion in global assets, Vanguard empowers everyday investors to build long-term wealth.
            </div>
            ...
            <div style={{
              ...
              Save for moments big and small &nbsp;•&nbsp; Use Vanguard for it all.
            </div>
          </div>
        </div>
      </div>
